import {Categories, Excel, Tuple} from "../../src/models/excelAnalyze";
import {AddBody, AddRequest, Header, YaoHealthProductInfo} from "../../src/models/Impl/requestPayloadImpl";
